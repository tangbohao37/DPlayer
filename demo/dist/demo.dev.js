...
function handleEvent() {
  document.getElementById('dplayer-dialog').addEventListener('click', function (e) {
    var $clickDom = e.currentTarget;
    var isShowStatus = $clickDom.getAttribute('data-show');
  ...
  document.getElementById('close-dialog').addEventListener('click', function () {
    var $openDialogBtnDom = document.getElementById('dplayer-dialog');
...
function initPlayers() {
  ...
  window.dp1 = new DPlayer({
    ...
    video: {
      ...
      url: 'http://fhprodplay.tx-exhibition.com/live/test.flv',
      defaultQuality: 0
    },
    subtitle: {
  ...
  dp1.on('error', function (e) {
    console.log(e);
  });
  dp1.on('on_sources_tatus_change', function (e) {
    console.log(e);
  });
  dp1.on('on_reconnect', function (e) {
    console.log(e);
  });
  dp1.on('on_connected', function (e) {
    console.log(e);
  });
